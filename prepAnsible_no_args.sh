...
curl -O https://raw.githubusercontent.com/kaiAsmOne/DevOpsinc/main/requirements-azure.txt
...
/bin/su - sicraroot -c  "python3 -m pip install --user -r /home/sicraroot/requirements-azure.txt"
